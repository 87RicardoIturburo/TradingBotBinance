...
public sealed class RiskManagerTests
{
    ...
    public RiskManagerTests()
    {
        ...
        _sut = new RiskManager(_strategyRepo, _positionRepo, _accountService, globalRisk, NullLogger<RiskManager>.Instance);
    }
    ...
    public async Task ValidateOrder_WhenGlobalDailyLossExceeded_ReturnsKillSwitch()
    {
        ...
        var sut = new RiskManager(_strategyRepo, _positionRepo, _accountService, globalRisk, NullLogger<RiskManager>.Instance);
